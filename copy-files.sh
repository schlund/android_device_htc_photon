...
cp $STAGESYS/etc/AudioFilterTable.csv ../../../vendor/htc/$DEVICE/proprietary
cp $STAGESYS/etc/AudioPara3.csv ../../../vendor/htc/$DEVICE/proprietary
cp $STAGESYS/etc/AudioPreProcessTable.csv ../../../vendor/htc/$DEVICE/proprietary
